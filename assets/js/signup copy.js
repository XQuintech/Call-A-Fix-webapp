...
function showThankYouPage(cafId) {
    ...
    thankYouMessage.innerHTML = `<h2>Your Request Has Been Submitted Successfully!</h2><p><strong>${cafId}</strong>. <br>  You can refer to your Email. We will contact you shortly for verifications.</p>`;
